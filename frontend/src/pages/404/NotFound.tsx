...
// import first from '../../assets/cityRegister.png';
// import second from '../../assets/checkInbox.png';
const NotFound = () => {
  return (
    <Parallax style={{
      marginLeft: 300,
      ...
      <ParallaxLayer offset={0}
        speed={1}>
        <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="500" height="834.5" viewBox="0 0 797.5 834.5" xmlnsXlink="http://www.w3.org/1999/xlink">
          <ellipse cx="308.5" cy="780" rx="308.5" ry="54.5" fill="#3f3d56" /><circle cx="496" cy="301.5" r="301.5" fill="#3f3d56" />
        </svg>
      </ParallaxLayer>
      <ParallaxLayer offset={0.4} speed={0.7}>
        <div className='pl-64'>
        <h1 className='text-white text-[70px]'>404</h1>
        <h2 className='text-white'>This route does not exist</h2>
        </div>
        ...
        <ParallaxLayer offset={0}
          speed={1}>
          <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="500" height="834.5" viewBox="0 0 797.5 834.5" xmlnsXlink="http://www.w3.org/1999/xlink"><circle cx="496" cy="301.5" r="203.99362" opacity="0.05" /></svg>

        </ParallaxLayer>
        <ParallaxLayer offset={0}
          speed={1}>
          <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="500" height="834.5" viewBox="0 0 797.5 834.5" xmlnsXlink="http://www.w3.org/1999/xlink"><circle cx="496" cy="301.5" r="146.25957" opacity="0.05" /></svg>
          {/* //done */}
        </ParallaxLayer>
        <ParallaxLayer offset={0}
          speed={0.5}>
        ...
        <ParallaxLayer offset={0}
          speed={0.5}>
          <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="500" height="834.5" viewBox="0 0 797.5 834.5" xmlnsXlink="http://www.w3.org/1999/xlink"><circle cx="54" cy="729.5" r="43" fill="#6c63ff" /><circle cx="54" cy="672.5" r="31" fill="#6c63ff" /><circle cx="54" cy="624.5" r="22" fill="#6c63ff" /></svg>

        </ParallaxLayer>
        <ParallaxLayer  offset={1.4}
          speed={2}>
          <h1 className='text-white text-xl'>Ooops</h1>
          <h2 className='text-white text-lg'>It looks like there is nothing here...</h2>
        </ParallaxLayer>
